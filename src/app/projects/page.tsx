...
import RegistrationLabel from "@/components/container/registration/labels";
...
const Project = () => {
  ...
  const formik = useFormik({
    initialValues: {
      emailOwner: "john.doe@example.com",
      phoneOwner: "01234567890",
      rawProjectDescription: "Elite project",
      projectName: "Sample Project",
      projectStack: "React, Node.js",
      projectPlatform: "Web",
      projectObjective: "Create a sample web application",
      isHaveDesign: "true",
      budgetRange: "5000",
    ...
    onSubmit: (values) => {
      axios
        .post(
          "https://students-tech-server-s7htybhruq-as.a.run.app/project/",
          values
        )
        .then(() => {
        ...
        .catch(() => toast.error("error when creating project"));
    },
  });
  ...
  useEffect(() => {
    ...
    axios
      .post(
        `https://students-tech-server-s7htybhruq-as.a.run.app/project/completion`,
        payload
      )
      .then(function (res) {
            ...
            <CardContent className="mt-5">
              <form>
                <div className="grid w-full items-center gap-4">
                  ...
                  <div className="grid w-full items-center gap-4">
                    <div className="flex flex-col space-y-1.5">
                      <Label htmlFor="name">Project Owners Email...</Label>
                      <Input
                        id="email"
                        name="email"
                        type="text"
      ...
      {step === 2 && (
        <div>
          <div className="py-5 px-5 w-screen bg-[#F8F9FA] flex justify-center items-center">
            <div className="font-semibold text-lg">Stubot</div>
          </div>
          <div className="mx-5 mt-5 pb-20">
            {listPrompt?.map((message, index) =>
              message?.role == "assistant" ? (
                ...
                index > 0 && <ClientDialog message={message.content} />
              )
            )}
          </div>
        ...
        <div className="w-full h-full p-8 md:p-16">
          <form onSubmit={formik.handleSubmit}>
            <RegistrationLabel
              ...
              type="text"
              required
              placeholder="students@tech.id"
              value={formik.values.emailOwner}
            ...
            <RegistrationLabel
              ...
              type="text"
              required
              placeholder="08123242424"
              value={formik.values.phoneOwner}
              onChange={formik.handleChange}
            />
            <RegistrationLabel
              title="Project nescription"
              label="rawProjectDescription"
              type="text"
              required
              placeholder="My project is.."
              value={formik.values.rawProjectDescription}
              onChange={formik.handleChange}
            />
            <RegistrationLabel
              title="Project name"
            ...
            <RegistrationLabel
              ...
              required
              placeholder="Web"
              value={formik.values.projectPlatform}
              onChange={formik.handleChange}
            />
            <RegistrationLabel
              title="Project objective"
              label="projectObjective"
              type="text"
              required
              placeholder="Save the world"
              value={formik.values.projectObjective}
              onChange={formik.handleChange}
            />
            <Button
              type="submit"
